...
Vendored from original ccpp_framework
(``ccpp_framework/scripts/parse_tools/parse_source.py``) so CAM-SIMA's
``hist_config.py`` (via ``parse_object.ParseObject``) keeps the
